...
PairLJSmoothheat::PairLJSmoothheat(LAMMPS *lmp) : Pair(lmp)
{
  writedata = 1;
}
...
PairLJSmoothheat::~PairLJSmoothheat()
{
  if (allocated) {
...
void PairLJSmoothheat::compute(int eflag, int vflag) {
...
void PairLJSmoothheat::computeNormal(int eflag, int vflag)
{
...
/* ---------------------------------------------------------------------- */
//Modified by manish/shshir
void PairLJSmoothheat::computeHeating(int eflag, int vflag)
{
  int i,j,ii,jj,inum,jnum,itype,jtype;
  double xtmp,ytmp,ztmp,delx,dely,delz,evdwl,fpair;
  double rsq,r2inv,r6inv,forcelj,factor_lj;
...
void PairLJSmoothheat::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJSmoothheat::settings(int narg, char **arg)
{
...
void PairLJSmoothheat::coeff(int narg, char **arg)
{
  if (narg != 4 && narg != 6)
...
double PairLJSmoothheat::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJSmoothheat::write_restart(FILE *fp)
{
...
void PairLJSmoothheat::read_restart(FILE *fp)
{
...
void PairLJSmoothheat::write_restart_settings(FILE *fp)
{
...
void PairLJSmoothheat::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairLJSmoothheat::write_data(FILE *fp)
{
...
void PairLJSmoothheat::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairLJSmoothheat::single(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
